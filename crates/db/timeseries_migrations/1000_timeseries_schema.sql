...
CREATE TABLE IF NOT EXISTS timeseries_offsets(
  topic             TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS timeseries_trades(
...
CREATE INDEX IF NOT EXISTS timeseries_trades_market_executed_at_idx
  ON timeseries_trades(market_id, executed_at DESC);

CREATE INDEX IF NOT EXISTS candles_market_interval_bucket_desc_idx
